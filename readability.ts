...
// ver o tamanho das palavras e o tamanho das frases
// a media de palavras em 100 letras e a media de frases a cada 100 palavras

let texto:string = 'adsin'
let quantLetras:number = 0
let quantPalavras:number = 0
let quantFrases:number | undefined = 0

function separarLetras(texto:string){
...
function separarFrases(texto:string){

    quantFrases = texto.match(/!|\?|\./g)?.length

}

function separarAll(texto:string){
